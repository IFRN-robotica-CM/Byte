#define DBP_ME 65 // Divisor branco e preto do sensor Mais Esquerdo
#define DBP_E 65  // Divisor branco e preto do sensor Esquerdo
#define DBP_D 88  // Divisor branco e preto do sensor Direito
#define DBP_MD 65 // Divisor branco e preto do sensor Mais Direito
